  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admin/index3.html" class="brand-link">
      <img src="/admin/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="">Infromasi Mahasiswa</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/admin/dist/img/user9.jpeg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="">Maheswara Wira Yoganata</a>
        </div>
      </div>
    ...
    @yield('content')
      ...
      <footer class="main-footer">
        ...
        <strong>Maheswara Wira Yoganata - 20/10/1999 - <a href="https://github.com/mhswaraa">My Link GitHub</a>.</strong> Man jadda wa jadda
      </footer>
